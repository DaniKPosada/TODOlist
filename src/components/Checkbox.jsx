...
const Checkbox = (props) => {
    ...
    return (
        <Fragment>{/* codigo para evitar envolver esto con miles de div */}
            {/* codigo para trabajar con el svg y su respectiva animación */}
            <svg
                viewBox="0 0 0 0"
            ...
            >
             ...
             {/* Codigo para determinar los atributos de la checkbox */}
